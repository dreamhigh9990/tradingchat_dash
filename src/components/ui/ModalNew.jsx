            ...
            <div className="fixed inset-0 overflow-y-auto">
              ...
              >
                ...
                >
                  <Dialog.Panel
                    className={`w-full transform overflow-hidden rounded-md
                 bg-slate-800 text-left align-middle shadow-xl transition-alll ${className}`}
                  >
                    <div
                      className={`relative overflow-hidden py-4 px-5 text-white flex justify-between  ${themeClass}`}
                    >
                    ...
                    <div
                      className={`px-6 py-8 bg-slate-800 text-gray-300 ${scrollContent ? "overflow-y-auto max-h-[400px]" : ""
                        }`}
                    >
                      {children}
                    </div>
                    {footerContent && (
                      <div className="bg-slate-800 px-4 py-3 flex justify-end space-x-3">
                        {footerContent}
                      </div>
                    )}
                  </Dialog.Panel>
