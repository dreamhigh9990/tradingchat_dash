    ...
    >
      ...
      {(!collapsed || menuHover) && (
        <div
          ...
          ${collapsed
              ? "ring-2 ring-inset ring-offset-8 ring-black-800 dark:ring-slate-500 bg-slate-900 dark:bg-slate-200 dark:ring-offset-slate-500"
