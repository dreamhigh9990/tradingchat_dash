    ...
    <div className="bg-slate-800 py-12 sm:py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-300">
          An affordable plan that’s packed with the best features for engaging your interests.
        </p>
        ...
        <div className="isolate mx-auto mt-10  grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-1 flex justify-center">
          {tiers.map((tier) => (
            <div
              key={tier.id}
        ...
        </div><div className="mx-auto max-w-4xl text-center">
          {/* <h2 className="text-base font-semibold leading-7 text-indigo-400">Pricing</h2> */}
          <Link
                    href="login"
                    className="text-slate-900 dark:text-white font-medium hover:underline"
